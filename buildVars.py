...
addon_info = {
	...
	"addon_name" : "HeadphoneFinder",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on to be shown on installation and add-on information.
	"addon_summary" : _("Headphone Finder"),
	# Add-on description
	...
	"addon_url" : "https://github.com/david-acm/NVDA-headphoneFinder",
...
pythonSources = [path.join("addon", "globalPlugins", "headphoneFinder.py")]
